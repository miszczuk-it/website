...
function successfulClient(overrides: Partial<PlatformApiClient> = {}): PlatformApiClient {
  return {
    ...
    activateSpecialistProfileVersion: async (specialistType) => ({ specialistProfileVersionId: 'stub', specialistType, versionNumber: 1, status: 'ACTIVE', systemPrompt: '', responsibilities: '', excludedResponsibilities: '', expectedOutputGuidance: '', modelProfileKey: 'default' }),
    ...overrides,
  }
}
